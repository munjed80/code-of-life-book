...
FILES_ORDER: List[Tuple[str, str]] = [
    ...
    ("chapter-25.md", "الفصل الخامس والعشرون"),
    ("chapter-26.md", "الفصل السادس والعشرون"),
    ("chapter-27.md", "الفصل السابع والعشرون"),
    ("chapter-28.md", "الفصل الثامن والعشرون"),
    ("chapter-29.md", "الفصل التاسع والعشرون"),
    ("chapter-30.md", "الفصل الثلاثون"),
]
